...
(function($) {
    ...
    $.KumbiaPHP = {
        ...
        cConfirm: function(event) {
            ...
            var cajon       = $('<div class="modal-dialog modal-sm"></div>');
            ...
            if(este.hasClass('js-link')) {
                ...
                footer.append('<a class="btn btn-danger js-link js-spinner" href="'+data_to+'">'+gettext('Continuar')+'</a>');
            } else {
                footer.append('<button class="btn btn-danger">'+gettext('Continuar')+'</a>');
            }
            
            footer.append('<button class="btn btn-default" data-dismiss="modal" aria-hidden="true">'+gettext('Cancelar')+'</button>');
                        
            $('.btn-danger', dialogo).on('click',function(){
                dialogo.modal('hide')
